...
\begin{document}
	...
	\begin{center}
		\begin{minipage}[t]{0.5\textwidth}
			...
			\Large\textbf{\href{https://www.linkedin.com/in/svetlozar-kosev-m-sc-it-278058144/}{Svetlozar
					Vladkov Kosev}}\\[2ex]
			\includegraphics[width=5cm, height=5cm, keepaspectratio]{28-March-2026.JPG}
		\end{minipage}%
		\begin{minipage}[t]{0.5\textwidth}
	...
	\begin{center}
		...
		\begin{minipage}[t]{0.5\textwidth}
			...
			\begin{itemize}
				...
				\item Office 365 Business Premium Setup and IMAP Mailbox Migration
				
				\item Managed customer office relocations, configuring devices and resolving post-migration technical issues
				
				\item Exchange on-premises to Microsoft 365 hybrid migration for UK clients, from planning through cutover and post-migration support
				
				\item Endpoint \& Server Backup - Veeam Backup \& Replication with Wasabi Hot Cloud Storage
	...
	\begin{tabular}{@{}p{0.2\linewidth} p{0.75\linewidth}}
		\textbf{2 May 2018—2 September 2026} & IT Support Assistant — \href{https://www.goliveuk.com/}{Go Live UK Ltd.} \\
	\end{tabular}
	...
	\begin{minipage}[t]{0.5\textwidth}
		...
		\begin{itemize}
			...
			\item CMD and PowerShell Scripting
	...
	\begin{minipage}[t]{0.5\textwidth}
		\section*{}
		\begin{itemize}
			\item Windows Server Standard
			
			\item DISA STIGs Compliance
			...
			\item Veeam Backup \& Replication with Wasabi Hot Cloud Storage
	...
	hMail Server, Hyper-V failover, IASME compliance, IIS web server, DISA STIGs, Office
